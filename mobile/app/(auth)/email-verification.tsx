...
export default function EmailVerificationScreen() {
  ...
  async function finishNotificationIntro(enableNotifications: boolean) {
    try {
      ...
      if (enableNotifications) await enablePhoneNotifications();
    } catch {
    } finally {
...
const styles = StyleSheet.create({
  logoWrap: { alignItems: "center" }, copy: { gap: spacing.md }, title: { color: colors.whiteText, fontWeight: "900", fontSize: 30 }, body: { color: colors.mutedText, lineHeight: 22 }, message: { color: colors.primaryGreen, fontWeight: "800" }, error: { color: colors.danger, fontWeight: "700" },
  modalBackdrop: { flex: 1, justifyContent: "center", padding: spacing.xl, backgroundColor: "rgba(17,20,23,0.28)" }, modalCard: { alignItems: "center", gap: spacing.md, padding: spacing.xl, borderRadius: 30, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.card }, modalTitle: { color: colors.whiteText, fontSize: 26, fontWeight: "900" }, modalBody: { color: colors.mutedText, textAlign: "center", lineHeight: 22 }, modalActions: { alignSelf: "stretch", gap: spacing.sm },
});
