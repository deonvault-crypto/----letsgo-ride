...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: colors.card, borderRadius: 30, borderWidth: 1, borderColor: colors.border, padding: spacing.xl, gap: spacing.md, shadowColor: colors.black, shadowOpacity: 0.06, shadowRadius: 18, shadowOffset: { width: 0, height: 10 }, elevation: 4 },
  ...
  forgot: { alignSelf: "flex-end", color: colors.primaryGreen, fontWeight: "900", fontSize: 13 },
  message: { color: colors.primaryGreen, fontWeight: "800" },
  error: { color: colors.danger, fontWeight: "700" },
  inlineActions: { gap: spacing.sm },
  footer: { color: colors.mutedText, textAlign: "center", fontWeight: "800", fontSize: 12, paddingBottom: spacing.md },
