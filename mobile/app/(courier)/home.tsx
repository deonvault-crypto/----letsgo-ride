        ...
        <>
          <View style={styles.activeHero}>
            ...
            <View style={styles.metricsRow}>
              ...
              <HeroMetric label="EARN" value={active.courier_payout_usd != null ? `$${active.courier_payout_usd.toFixed(2)}` : "—"} />
            </View>
          </View>
