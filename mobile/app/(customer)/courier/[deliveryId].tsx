...
import { CourierDelivery, CourierDeliveryPin, CourierEvent, CourierStatus } from "../../../types/courier.types";
...
const styles = StyleSheet.create({
  ...
  heroBadge: { width: 38, height: 38, borderRadius: 13, backgroundColor: "rgba(255,255,255,0.11)", alignItems: "center", justifyContent: "center" },
  eyebrow: { flex: 1, color: "#A8E7BC", fontSize: 9, fontWeight: "900", letterSpacing: 1.1 },
  price: { color: "#FFFFFF", fontSize: 17, fontWeight: "900" },
  title: { color: "#FFFFFF", fontSize: 27, lineHeight: 32, fontWeight: "900", letterSpacing: -0.8 },
  body: { color: "rgba(255,255,255,0.7)", fontSize: 11, lineHeight: 17 },
  statusRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginTop: 4 },
  statusPill: { borderRadius: 999, backgroundColor: "rgba(255,255,255,0.1)", paddingHorizontal: 9, paddingVertical: 6, flexDirection: "row", alignItems: "center", gap: 6 },
  statusDot: { width: 7, height: 7, borderRadius: 4, backgroundColor: "rgba(255,255,255,0.45)" },
  statusDotLive: { backgroundColor: "#8FE6AE" },
  statusText: { color: "#FFFFFF", fontSize: 8, fontWeight: "900" },
  orderId: { color: "rgba(255,255,255,0.45)", fontSize: 8, fontWeight: "900" },
  matchCard: { minHeight: 154, borderRadius: v2Theme.radius.xxl, backgroundColor: v2Theme.colors.brandSofter, padding: 15, flexDirection: "row", alignItems: "center", gap: 16, overflow: "hidden" },
  radar: { width: 116, height: 116, alignItems: "center", justifyContent: "center" },
  radarRing: { position: "absolute", width: 86, height: 86, borderRadius: 43, borderWidth: 2, borderColor: v2Theme.colors.brand },
  radarCore: { width: 54, height: 54, borderRadius: 27, backgroundColor: v2Theme.colors.brand, alignItems: "center", justifyContent: "center" },
  courierDot: { position: "absolute", width: 34, height: 34, borderRadius: 17, backgroundColor: "#FFFFFF", alignItems: "center", justifyContent: "center", shadowColor: v2Theme.colors.shadow, shadowOpacity: 0.12, shadowRadius: 8, elevation: 3 },
  courierDotOne: { top: 5, right: 4 }, courierDotTwo: { bottom: 4, left: 1 }, courierDotThree: { bottom: 8, right: 0 },
  matchCopy: { flex: 1, gap: 6 }, matchTitle: { color: v2Theme.colors.ink, fontSize: 17, fontWeight: "900", letterSpacing: -0.3 }, matchBody: { color: v2Theme.colors.inkSecondary, fontSize: 10, lineHeight: 15 },
  searchingRow: { flexDirection: "row", alignItems: "center", gap: 7, marginTop: 3 }, searchingDot: { width: 7, height: 7, borderRadius: 4, backgroundColor: v2Theme.colors.brand }, searchingText: { color: v2Theme.colors.brandStrong, fontSize: 8, fontWeight: "900" },
  courierCard: { borderRadius: v2Theme.radius.xl, backgroundColor: v2Theme.colors.surface, padding: 14, flexDirection: "row", alignItems: "center", gap: 11, borderWidth: StyleSheet.hairlineWidth, borderColor: v2Theme.colors.brandSoft },
  courierAvatar: { width: 54, height: 54, borderRadius: 19, backgroundColor: v2Theme.colors.brand, alignItems: "center", justifyContent: "center" }, courierCopy: { flex: 1, gap: 3 }, courierEyebrow: { color: v2Theme.colors.brandStrong, fontSize: 8, fontWeight: "900", letterSpacing: 0.7 }, courierName: { color: v2Theme.colors.ink, fontSize: 15, fontWeight: "900" }, courierBody: { color: v2Theme.colors.inkSecondary, fontSize: 9, lineHeight: 14 }, liveBadge: { borderRadius: 999, backgroundColor: v2Theme.colors.brandSoft, paddingHorizontal: 8, paddingVertical: 5 }, liveBadgeText: { color: v2Theme.colors.brandStrong, fontSize: 7, fontWeight: "900" },
  ...
  pinCard: { borderRadius: v2Theme.radius.xxl, backgroundColor: v2Theme.colors.brandSofter, padding: 16, gap: 14, borderWidth: StyleSheet.hairlineWidth, borderColor: v2Theme.colors.brandSoft }, pinHeader: { flexDirection: "row", gap: 11, alignItems: "center" }, pinIcon: { width: 50, height: 50, borderRadius: 17, backgroundColor: v2Theme.colors.brandSoft, alignItems: "center", justifyContent: "center" }, pinCopy: { flex: 1, gap: 3 }, pinTitle: { color: v2Theme.colors.ink, fontSize: 16, fontWeight: "900" }, pinBody: { color: v2Theme.colors.inkSecondary, fontSize: 10, lineHeight: 15 },
  pinDigits: { flexDirection: "row", justifyContent: "center", gap: 9 }, pinDigit: { width: 52, height: 62, borderRadius: 18, backgroundColor: v2Theme.colors.surface, alignItems: "center", justifyContent: "center", borderWidth: StyleSheet.hairlineWidth, borderColor: v2Theme.colors.lineStrong }, pinDigitText: { color: v2Theme.colors.ink, fontSize: 27, fontWeight: "900" },
  securityRow: { borderRadius: 16, backgroundColor: v2Theme.colors.surface, padding: 11, flexDirection: "row", gap: 8, alignItems: "flex-start" }, securityText: { flex: 1, color: v2Theme.colors.inkSecondary, fontSize: 9, lineHeight: 14 },
