...
export default function CourierOnboardingScreen() {
  ...
  return (
    <Screen showBack fallbackRoute="/(driver)/work" title="Courier onboarding" showNotifications={false}>
      <View style={styles.hero}>
        <Text style={styles.eyebrow}>COURIER MODE</Text>
        <Text style={styles.title}>Set up how you deliver.</Text>
        <Text style={styles.body}>Your courier profile stays separate from ride-posting. Approval is required before going online.</Text>
      </View>
            ...
            return (
              ...
              >
                <View style={[styles.modeIcon, active && styles.modeIconActive]}>
                  <MaterialCommunityIcons name={item.icon} size={26} color={active ? "#FFFFFF" : v2Theme.colors.ink} />
                </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.inputCard}>
          ...
          <TextInput
            accessibilityLabel="Courier vehicle description"
            value={vehicleDescription}
            onChangeText={setVehicleDescription}
            maxLength={180}
            placeholder="e.g. Honda CB125, black delivery box"
      ...
      <View style={styles.reviewCard}>
        ...
        <View style={styles.reviewCopy}>
          <Text style={styles.reviewTitle}>Approval before online work</Text>
          <Text style={styles.reviewBody}>Creating a profile does not make the account instantly eligible for courier jobs. Operations approval remains a separate gate.</Text>
        </View>
      </View>
