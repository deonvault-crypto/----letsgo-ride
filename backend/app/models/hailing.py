...
class HailingCityUpsertBody(BaseModel):
    ...
    economy_base_fare: float = Field(default=2.00, ge=0, le=1000)
    economy_per_km: float = Field(default=0.80, ge=0, le=100)
    economy_per_minute: float = Field(default=0.08, ge=0, le=100)
    economy_minimum_fare: float = Field(default=3.00, ge=0, le=1000)
    economy_booking_fee: float = Field(default=0.50, ge=0, le=1000)
    economy_cancellation_fee: float = Field(default=0.00, ge=0, le=1000)
    economy_platform_commission_percent: float = Field(default=15.0, ge=0, le=50)
    ...
    comfort_base_fare: float = Field(default=3.00, ge=0, le=1000)
    comfort_per_km: float = Field(default=1.05, ge=0, le=100)
    comfort_per_minute: float = Field(default=0.10, ge=0, le=100)
    comfort_minimum_fare: float = Field(default=4.50, ge=0, le=1000)
    comfort_booking_fee: float = Field(default=0.75, ge=0, le=1000)
    comfort_cancellation_fee: float = Field(default=0.00, ge=0, le=1000)
    comfort_platform_commission_percent: float = Field(default=15.0, ge=0, le=50)
    ...
    xl_base_fare: float = Field(default=4.00, ge=0, le=1000)
    xl_per_km: float = Field(default=1.35, ge=0, le=100)
    xl_per_minute: float = Field(default=0.12, ge=0, le=100)
    xl_minimum_fare: float = Field(default=6.00, ge=0, le=1000)
    xl_booking_fee: float = Field(default=1.00, ge=0, le=1000)
    xl_cancellation_fee: float = Field(default=0.00, ge=0, le=1000)
    xl_platform_commission_percent: float = Field(default=15.0, ge=0, le=50)
