...
from app.routers import admin, auth, conversations, drivers, facetec, health, media, notifications, reports, requests, rides, support, verification, waitlist
...
app.include_router(facetec.router)
